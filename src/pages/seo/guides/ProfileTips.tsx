...
const ProfileTips = () => {
  return (
    ...
    >
      ...
      <p className="text-muted-foreground leading-relaxed">
        A single photo only tells part of the story. Upload multiple images that show different angles, outfits, and settings. A mix of close-up and full-body shots gives visitors a complete picture. Consider including at least one photo in a setting that reflects your personality — a favourite cafe, a well-dressed evening look, or a casual outdoor shot. Variety builds confidence in your profile's authenticity and gives visitors more reasons to reach out.
      </p>
      ...
      <p className="text-muted-foreground leading-relaxed">
        Pinklights offers a visibility boost that pushes your profile higher in search results during peak browsing times. This feature is especially valuable when you first create your profile or when you return after a period of inactivity. A boosted profile gets more views, which translates to more WhatsApp contacts. Consider timing your boosts strategically — evenings and weekends tend to see higher traffic. Use boosts when you are actually available to respond, so you can capitalise on the increased visibility immediately.
      </p>
