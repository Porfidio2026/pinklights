...
const HowItWorks = () => {
  return (
    ...
    >
      ...
      <p className="text-muted-foreground leading-relaxed">
        After choosing a service type, you can further refine your search by selecting gender preferences. This combination of service type and preference ensures the profiles you see are aligned with what you are genuinely interested in, with no irrelevant results cluttering your experience.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-3">Step 4: Browse Profiles with Filters</h2>
      <p className="text-muted-foreground leading-relaxed">
        The search results page displays profile cards with photos, basic details, and location information. You can filter further by city or distance radius (up to 50 km from your chosen location), as well as physical attributes such as appearance, age range, and other details. Belgium is compact, so someone listed in Antwerp might be just 30 minutes from Ghent or Brussels. The distance filter lets you decide how far you are willing to travel.
      </p>
