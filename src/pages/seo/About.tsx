...
const About = () => {
  return (
    <ContentPageTemplate
      ...
      metaTitle="About Pinklights - Companion Platform in Belgium"
    ...
    >
      ...
      <h2 className="text-xl font-semibold mt-6 mb-3">Our Presence in Belgium</h2>
      <p className="text-muted-foreground leading-relaxed">
        Belgium is our first and primary market. We understand the local landscape: the bilingual reality of Flemish and Walloon regions, the compact distances between cities, and the importance of privacy in a small country where discretion matters. Our platform supports multiple languages and covers cities across both regions, from Antwerp and Ghent to Brussels, Liege, and Namur.
      </p>
      <p className="text-muted-foreground leading-relaxed mt-3">
        We are fully compliant with European and Belgian privacy regulations. We take GDPR compliance seriously: your data is stored securely, you have the right to access and delete your information, and we do not sell personal data to third parties. Read more about our security measures on our <a href="/safety" className="text-primary hover:underline">safety page</a>.
      </p>
