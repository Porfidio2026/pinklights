...
const BrugesPage = () => {
  return (
    <CityLandingTemplate
      ...
      metaDescription="Find premium companions in Bruges. Discover discreet connections in Belgium's most romantic city with canal-side walks, fine dining, and intimate evenings."
