    ...
    <CityLandingTemplate
      ...
      faqItems={[
        ...
        },
        {
          ...
          answer: 'Yes. Dining, drinks, and accommodation in Liège tend to be noticeably more affordable than in Brussels, Antwerp, or Ghent. This makes it possible to enjoy premium experiences like fine restaurants and boutique hotels at a fraction of what you might expect.',
        },
      ]}
      relatedCities={[
        {
